...
public class GameMain {
    ...
    GameMain(String pName){
        ...
        this.balance = 100;//setting start ammount of money
        ...
        // Game Starts here ,checks user input
        ...
        System.out.println("\n"+this.playerName+"*******The game is now over, Thx for playing, hava a nice day!*****");
    ...
    // Deal the game, checking Exceptions, ad bet
    ...
    private void decideWinner(){
        ...
        if(youSum>dealerSum && youSum<=21 || dealerSum >21){
            ...
            System.out.printf("Your Current Balance:$%.1f\n", this.balance);
                ...
                //starting the game,get user name
    public static void main(String[] args) {
        ...
        System.out.println("\t\t\t\t         Welcome to FUNZONE         ");
